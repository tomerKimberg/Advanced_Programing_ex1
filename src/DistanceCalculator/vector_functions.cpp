 ...
 * @return vector backup, where every element in index0 i is the sum of those elements in vectors v1 and v2
 */
 ...
 * @param v1 vector given my user
 * @param v2 vector given my user
 * @return vector backup, where every element in index0 i is the subtraction of x[i] of v1 from y[i] of v2
 */
 ...
 * @param v1 vector given my user
 * @param v2 vector given my user
 * @return vector backup, where every element in index0 i is the absolute value of that element at index0 i in v1
 */
 ...
 * @param v1 vector given my user
 * @param v2 vector given my user
 * @return vector backup, where every element in index0 i is the division of x[i] of v1 from y[i] of v2.
 */
